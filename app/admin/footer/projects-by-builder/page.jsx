...
export default function AdminFooterProjectBuilder() {
  ...
  const loadData = async () => {
    const snap = await getDoc(doc(db, "footer_links", "projects_by_builder"));
    setData(snap.data());
  };
  ...
  const saveSingle = async (item) => {
    try {
      ...
      await updateDoc(doc(db, "footer_links", "projects_by_builder"), {
        links: updatedLinks,
      });
    } finally {
      setSavingId(null);
            ...
            <div className="mb-8">
              ...
              <div className="border rounded-lg overflow-hidden">
                <RichEditor
                  ...
                  onChange={(val) => updateField(item.id, "description", val)}
                />
              </div>

              <p className="text-xs text-gray-500 mt-2">
                You can use full Word-style formatting (tables, images, headings, links, etc.)
              </p>
            </div>
              ...
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  <input
                    ...
                    className="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#DBA40D]"
                    placeholder="https://www.neevrealty.com/top-builders-in-gurgaon"
                  />
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  <input
                    ...
                    className="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#DBA40D]"
                    placeholder="top builders, developers, projects by builder"
                  />
                </div>
