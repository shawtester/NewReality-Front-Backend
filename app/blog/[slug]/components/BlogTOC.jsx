...
export default function BlogTOC({
  ...
  return (
    <div className="bg-white rounded-lg p-1 shadow-sm w-full lg:w-[320px] xl:w-[340px]">
          ...
          return (
            <li key={item.id}>
              ...
              <button
                ...
                className={`
                  w-full text-left px-0 py-0 border-l-2 transition-all duration-200
                  ${activeId === item.id
                ...
                `}
              >
                <span className="grid grid-cols-[28px_1fr] gap-2">
                    ...
                    return (
                      <li key={child.id}>
                        <button
                          ...
                          className={`
                            w-full text-left pl-6 pr-2 py-0 border-l-2 transition-all duration-200 text-[13px]
                            ${activeId === child.id
