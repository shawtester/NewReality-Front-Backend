...
export default function CommercialPage({ apartments = [] }) {
    ...
    useEffect(() => {
        ...
        // ✅ DYNAMIC TITLE - Priority: Type > BHK > Status > Locality > Budget
        let title = getDynamicHeading(urlType) || "Commercial Properties for Sale in Gurgaon";
        if (urlBhk) {
        ...
        // Auto search OR fallback to all commercial properties
    ...
    }, [keyword, type, status, locality, budget, bhk, apartments, searchParams, router]);
