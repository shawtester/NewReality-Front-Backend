...
export default function Navbar() {
  ...
  return (
    <header className="fixed  top-0 z-50 bg-white w-full">
      <nav className="mx-auto flex min-h-[70px] items-center justify-between px-4 py-3 sm:px-6 min-[800px]:h-[102px] max-w-[1212px]">
      ...
      {menuOpen && (
        <>
          ...
          <div className="fixed left-0 right-0 top-[70px] z-50 bg-white shadow-md min-[800px]:top-[102px] min-[800px]:hidden">
