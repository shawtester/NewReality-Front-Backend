...
export default function ResidentialPage({ apartments = [], forcedTypeSlug }) {
    ...
    // ✅ BANNER FETCH
    useEffect(() => {
        const RESIDENTIAL_SLUG_TO_CATEGORY = {
            "luxury-apartments-in-gurgaon": "apartment",
            "builder-floor-in-gurgaon": "builder-floor",
        };

        let category =
            RESIDENTIAL_SLUG_TO_CATEGORY[forcedTypeSlug] || "residential";
        ...
        fetchBanner();
    }, [forcedTypeSlug, searchParams, pageTitleDynamic]);
    ...
    // 🔥 Hide Type Filter for SEO Slugs
